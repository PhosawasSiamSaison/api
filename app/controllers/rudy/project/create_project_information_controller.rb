...
class Rudy::Project::CreateProjectInformationController < Rudy::ApplicationController
  def call
    ...
    error, result = create_site_error_check(true, is_project: true)
