...
class Rudy::Cpac::SendNewSiteInformationController < Rudy::ApplicationController
  def call
    ...
    error, result = create_site_error_check(false)
    ...
    contractor.contractor_users.each do |contractor_user|
      SendMessage.send_new_site_information(contractor_user, site_information)
    end
